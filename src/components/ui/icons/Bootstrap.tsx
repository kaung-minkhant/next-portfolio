...
export function BootstrapIcon({ width = 100, height = 100 }: IconType) {
  return <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/bootstrap/bootstrap-original.svg" width={width} height={height} alt="bootstrap icon"/>
