...
export function NodeJSIcon({ width = 100, height = 100 }: IconType) {
  return  <Image src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original-wordmark.svg" width={width} height={height} alt="nodejs icon" />
  return (
    <svg
      viewBox="0 0 128 128"
      width={width}
