...
import Skills from "./SkillExperienceEducation/Skills";
import Education from "./SkillExperienceEducation/Education";
import Experience from "./SkillExperienceEducation/Experience";
        ...
        <div className="col-span-3 mt-5 lg:mt-0 flex flex-col gap-5 h-full">
          <div>
            ...
            <p className="text-xl text-muted-foreground text-justify">
              My name is Kaung Min Khant. I am a Full Stack Developer from
